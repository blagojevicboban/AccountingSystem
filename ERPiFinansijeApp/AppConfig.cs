...
public static class AppConfig
{
    ...
    /// <summary>
    /// Tačno kada je reč o podrazumevanoj bazi (accounting.db) u kojoj još nema nijedne firme —
    ...
    {
        if (!string.Equals(Path.GetFileName(putanja), "accounting.db", StringComparison.OrdinalIgnoreCase))
        {
            return false;
        }
