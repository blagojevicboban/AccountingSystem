...
using ERPiFinansijeApp.Views.Backup;
using ERPiFinansijeApp.Views.Dashboard;
using ERPiFinansijeApp.Views.Izvestaji;
using ERPiFinansijeApp.Views.Kartice;
using ERPiFinansijeApp.Views.Magacin;
using ERPiFinansijeApp.Views.Nalozi;
using ERPiFinansijeApp.Views.Partneri;
using ERPiFinansijeApp.Views.Pomoc;
using ERPiFinansijeApp.Views.Trgovina;
    ...
    private async System.Threading.Tasks.Task CheckForUpdatesAsync()
    {
        try
        {
            var source = new Velopack.Sources.GithubSource(
                "https://github.com/blagojevicboban/ERPiFinansije",
                null,
                false);
