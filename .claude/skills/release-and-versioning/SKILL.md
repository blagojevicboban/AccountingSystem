...
description: How to cut a new release of ERPiFinansijeApp — bumping version.txt, triggering the GitHub Actions Velopack release workflow, and how the Velopack auto-update client works. Use whenever asked to release, publish, bump the version, tag a build, or troubleshoot auto-update.
---
...
- [version.txt](file:///C:/KNJIGE/ERPiFinansije/version.txt) at the repo root holds the plain version string, e.g. `1.0.0` (no `v` prefix, no quotes, no trailing newline content beyond the number).
