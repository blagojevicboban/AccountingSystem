...
vpk pack --packId "AccountingSystem" --packVersion "$version" --packDir "publish_output" --mainExe "AccountingApp.exe" --outputDir "ReleasePackage" --packTitle "ERPi Finansije" --packAuthors "Blagojevic Boban" --icon "AccountingApp\app.ico"
